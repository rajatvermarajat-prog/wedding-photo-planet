...
export const PERMISSION_MODULES: PermissionModule[] = [
  ...
  },
  {
    ...
    permissions: [
      ...
      p('employees.view_salary', 'View Salary', ALL, true),
      p('employees.manage_salary', 'Manage Salary', ALL, true),
      ...
      p('attendance.view_self', 'View Own Attendance', OWN),
      p('attendance.view', 'View All Attendance'),
      p('attendance.create', 'Create Attendance', ALL, true),
      p('attendance.update', 'Update Attendance', ALL, true),
      p('attendance.delete', 'Delete Attendance', ALL, true),
...
export const ROLE_UI_MODULE_OVERRIDE: Record<string, string> = {
  ...
  EMPLOYEE_CONTACT_VIEW: 'team',
  EMPLOYEE_SALARY_VIEW: 'team',
  EMPLOYEE_SALARY_MANAGE: 'team',
  EMPLOYEE_DOCUMENTS_VIEW: 'team',
  EMPLOYEE_DOCUMENTS_MANAGE: 'team',
  ATTENDANCE_VIEW_SELF: 'team',
  ATTENDANCE_VIEW: 'team',
  ATTENDANCE_VIEW_ALL: 'team',
  ATTENDANCE_MARK: 'team',
  ATTENDANCE_CREATE: 'team',
