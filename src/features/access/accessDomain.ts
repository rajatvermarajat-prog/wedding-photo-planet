...
export const UI_PERMISSION_ALIASES: Record<string, string> = {
  ...
  'weddings.view_all': 'PROJECT_VIEW_ALL',
  'weddings.view_financial': 'PROJECT_FINANCIAL_VIEW',
  ...
  'finance.update_payment': 'PAYMENT_UPDATE',
  'finance.view_payment_milestones': 'PAYMENT_MILESTONE_VIEW',
  'finance.manage_payment_milestones': 'PAYMENT_MILESTONE_MANAGE',
  ...
  'leave.view_self': 'LEAVE_VIEW_SELF',
